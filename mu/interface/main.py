...
class ButtonBar(QToolBar):
    ...
    def __init__(self, parent):
        ...
        self.setToolButtonStyle(ToolButtonTextUnderIcon)
        self.setContextMenuPolicy(PreventContextMenu)
    ...
    def change_mode(self, mode):
        ...
        self.addAction(
            name="modes",
            display_name=_("Mode"),
            tool_text=_("Change Mu C# IDE mode."),
        )
        self.addSeparator()
        self.addAction(
            name="new",
            display_name=_("New"),
            tool_text=_("Create a new C# file or project."),
        )
        self.addAction(
            name="load",
            display_name=_("Load"),
            tool_text=_("Open a C# file or project."),
        )
        self.addAction(
            name="save",
            display_name=_("Save"),
            tool_text=_("Save the current file."),
        )
        self.addSeparator()
        ...
        self.addAction(
            ...
            tool_text=_(
                "Toggle theme between dark or high contrast."
            ),
        )
        self.addSeparator()
        self.addAction(
...
class FileTabs(QTabWidget):
    ...
    def addTab(self, widget, title):
        ...
        self.tabBar().setTabButton(tab_id, TabBarRightSide, container)
...
class Window(QMainWindow):
    ...
    title = _("Mu C# IDE {}").format(__version__)
    icon = "icon.png"
    timer = None
    usb_checker = None
    repl = None
    ...
    def set_theme(self, theme):
        ...
        """
        if theme not in ("night", "contrast"):
            theme = "night"
        self.theme = theme
        ...
        if "theme" in self.button_bar.slots:
    ...
    def set_checker_icon(self, icon):
        ...
        """
        if "check" in self.button_bar.slots:
    ...
    def show_message(self, message, information=None, icon=None):
        ...
        message_box.setWindowTitle("Mu C# IDE")
        if information:
    ...
    def show_confirmation(self, message, information=None, icon=None):
        ...
        message_box = QMessageBox(self)
        message_box.setText(message)
        message_box.setWindowTitle(_("Mu C# IDE"))
        if information:
            message_box.setInformativeText(information)
        if icon and hasattr(message_box, icon):
            message_box.setIcon(getattr(message_box, icon))
        ...
        logger.debug(message)
        logger.debug(information)
        return exec_dialog(message_box)
    ...
    def screen_size(self):
        ...
        """
        if hasattr(QApplication, "primaryScreen") and QApplication.primaryScreen():
    ...
    def setup(self, breakpoint_toggle, theme):
        ...
        self.setTabPosition(AllDockWidgetAreas, TabNorth)
        self.widget = QWidget()
